...
class MemoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect("employee/memo")->with('error', trans("নতুন হিসাব যুক্ত সম্পুর্ন হয়েছে!"));
    ...
    public function view($id)
    {
        ...
        return view('employee.view.view_memo',compact('memoDetails','memoData','total_amount'));
