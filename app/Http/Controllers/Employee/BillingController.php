...
class BillingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee.billing', compact('billingData','paid_bills','due_bill','subscribersData','total_bill','paid_today','due_this_month','total_this_month','paid_this_month')); 
    }
    ...
    public function collect_bills(Request $request)
    {
        ...
        return redirect('employee/subscriber/'.$client_id)->with('success', trans("Bills Collected Successfully"));
    }
    ...
    public function billcollection()
    {
        ...
        return view('employee.bill_collection', compact('billingData','paid_bills','due_bill','subscribersData','total_bill','paid_today','due_this_month','total_this_month','paid_this_month')); 
