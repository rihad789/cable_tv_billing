...
class BillingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee.billing', compact('billingData','paid_today','subscribersData','due_this_month','total_bill','total_this_month','paid_this_month')); 
    }
    ...
    public function generate_bills()
    {
        ...
        if ($countSubscriber == 0) {
            return redirect('employee/billing')->with('error', trans("অনুগ্রহ করে আগে গ্রাহক যোগ করুন।"));
        } else {
            ...
            return redirect('employee/billing')->with('success', trans("Bill generated sucessfully।"));
        }
    }
    ...
    public function update_bills(Request $request)
    {
        ...
        if ($checkBill->billing_status == "1") {
            return redirect('employee')->with('success', trans("Collection is already added to company account"));
        } else {
            ...
            $affectedRow = Billings::where('client_id', $request->client_id)
                ...
                return redirect('employee')->with('success', trans("Bill updated sucessfully"));
        }
    ...
    public function bill_collection()
    {
        ...
        return view('employee.bill_collection', compact('billingData','due_bill','subscribersData','total_bill','paid_today','due_this_month','total_this_month','paid_this_month')); 
