...
class SubscriberController extends Controller
{
    public function index()
    {
        ...
        return view('employee.subscriber',compact('subscriberData','areasData','total_sub','disconnect_sub','connected_sub'));
    }
    ...
    {
        //
        return view('employee.search_bill');
    }
    ...
    public function search_result($id)
    {
        ...
        return view('employee.search_bill',compact('id','due_month','due_bills','subscriberData','userData','billingData','dueBilldata'));
