...
class BillingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('billing', compact('billingData', 'paid_bills', 'due_bill', 'subscribersData', 'total_bill', 'paid_today', 'due_this_month', 'total_this_month', 'paid_this_month'));
    }
    ...
    public function collect_bills(Request $request)
    {
       ...
       $day=Carbon::tomorrow()->format('l m-d-Y');
        ...
        return redirect('subscriber/search/' . $client_id)->with('success', trans("Bills Collected Successfully"));
    }
    ...
    public function collect_collection($id)
    {
        ...
        return redirect('billing/bill_collection')->with('success', trans("Collection handedover Successfully"));
    ...
    public function billcollection()
    {
        ...
        return view('bill_collection', compact('collectors','billingData', 'paid_bills', 'due_bill', 'subscribersData', 'total_bill', 'paid_today', 'due_this_month', 'total_this_month', 'paid_this_month'));
    }
    ...
    public function generate_bills()
    {
        ...
        if ($countSubscriber == 0) {
            return redirect('billing')->with('error', trans("অনুগ্রহ করে আগে গ্রাহক যোগ করুন।"));
        } else {
            ...
            return redirect('billing')->with('success', trans("Bill generated sucessfully।"));
        }
    }
