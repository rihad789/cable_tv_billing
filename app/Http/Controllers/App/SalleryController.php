...
class SalleryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sallery', compact('salleryData', 'userData'));
    }
    ...
    public function add_sallery(Request $request)
    {
        ...
        if ($salleryCount == 0) {
            ...
            return redirect('sallery')->with('success', trans("Sallery Added Successfully"));
        } else {
            ...
            if ($payment_status->payment_status == 1) {
                ...
                if ($current_sallery_count == 1) {
                    return redirect('sallery')->with('success', trans("Current Month Sallery Already Added"));
                } else {
                    $sallery = Sallery::create([
                ...
                return redirect('sallery')->with('success', trans("Sallery Updated Successfully"));
            } else {
                return redirect('sallery')->with('error', trans("Sorry ,Previous Sallery Due"));
            }
        }
    }
    ...
    public function settle($id)
    {
        ...
        return redirect('sallery')->with('success', trans("Employee sallery settled sucessfully"));
    }
}
