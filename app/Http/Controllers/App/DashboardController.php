...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard',compact('subTotal','subToday','subMonth','subYear','totalEmployee','totalSallery','sallery_paid','sallery_due','sallery_status','locked_fund','total_bill','bill_paid','bill_due','totalMemo','total_products','grand_total'));
