...
class AccountController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('account', compact('locked_fund','totalEmployee','totalSallery','sallery_paid','sallery_due','sallery_status','totalMemo','payable_balance','total_bill','bill_paid','bill_due','total_products','grand_total')); 
    ...
    public function settle_account(Request $request)
    {
        ...
        if($checkColletors>0)
        {
            return redirect('account_diary')->with('success', trans("Please Collect all Collection first"));
        }
        else
        {
        ...
        {
            return redirect('account_diary')->with('success', trans("Account already settled this month successfully!"));
        }
        else
        {
         ...
         return redirect('account_diary')->with('success', trans("Account settled successfully!"));
    ...
    public function settlements()
    {
        ...
        return view('settlements', compact('settlementsData')); 
