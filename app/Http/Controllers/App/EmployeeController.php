...
class EmployeeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee', compact('user', 'role_id'));
    }
    ...
    public function add_employee(Request $request)
    {
        ...
        if ($emailExist >= 1) {
            ...
            return redirect('employee')->with('success', trans("Employee registered successfully!"));
        }
    }
    ...
    public function view_employee($id)
    {
        ...
        return view('view.view_employee', compact('userData'));
    ...
    public function update_employee(Request $request)
    {
        ...
        if ($affectedRow == 1) {
            return redirect('employee/' . $id)->with('success', trans("Employee Profile Updated Successfully!"));
        } else {
    ...
    public function delete_employee($id)
    {
        ...
        if ($affectedRow == 1) {
            ...
            if ($affectedRowRole == 1) {
                ...
                return redirect('employee')->with('success', trans("Employee Deleted successfully!"));
            }
        }
    }
