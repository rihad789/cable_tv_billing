...
class SubscriberController extends Controller
{
    public function index()
    {
        ...
        return view('manager.subscriber',compact('subscriberData','areasData','total_sub','disconnect_sub','connected_sub'));
    }
    ...
    public function add_subscriber(Request $request)
    {
        ...
        if($client_id==1)
        {
            return redirect("manager/subscriber")->with('error', trans("সরি! গ্রাহকের আইডি আগে থেকে ডাটাবেজে আছে।"));
        }
        else
        {
    ...
    {
        //
        return view('manager.search_bill');
    }
    ...
    public function search_result($id)
    {
        ...
        return view('manager.search_bill',compact('id','due_month','due_bills','subscriberData','userData','billingData','dueBilldata'));
