...
class AreaController extends Controller
{
    ...
    public function area()
    {
        ...
        return view('manager.area', compact('areasData'));
    }
    ...
    public function add_area(Request $request)
    {
        ...
        if ($check_area == 1) {
            return redirect("manager/area")->with('error', trans("Sorry!This area already exists in the database"));
        } else {
        ...
        return redirect("manager/area")->with('error', trans("New Area added sucessfully!"));
    }
    ...
    public function vicinity()
    {
        ...
        return view('manager.vicinity', compact('areasData', 'vicinitiesData'));
    }
    ...
    public function add_vicinity(Request $request)
    {
        ...
        if ($check_vicinity == 1) {
            return redirect("manager/vicinity")->with('error', trans("Sorry! This vicinity already exist in the database"));
        } else {
        ...
        return redirect("manager/vicinity")->with('error', trans("New Vicinity added successfully!"));
    }
    ...
    public function delete_vicinity($id)
    {
        ...
        if ($affectedRow == 1) {
            return redirect('manager/vicinity')->with('success', trans("Vicinity Deleted successfully!"));
        }
    }
}
