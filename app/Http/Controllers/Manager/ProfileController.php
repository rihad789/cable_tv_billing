...
class ProfileController extends Controller
{
    ...
    public function my_profile()
    {
        ...
        return view('manager.my_profile', compact('userData'))->with('message');
    }
    ...
    public function my_account()
    {
        ...
        return view('manager.my_profile', compact('userData'));
    }
    ...
    public function update_account(Request $request)
    {
        ...
        if ($affectedRow == 1) {
            return redirect('manager/my_profile')->with('success', trans("Account Updated Successfully!"));
        } else {
    ...
    public function update_password(Request $request)
    {
        ...
        if (Hash::check($old_password, $oldPasswordHash->password)) {
            ...
            if ($affectedRow == 1) {
                ...
                return redirect('/manager/my_profile')->with('success', trans("Password changed successfully!"));
            }
        } else {
