...
class UserController extends Controller
{
    ...
    public function admin_profile()
    {
        ...
        return view('manager.profile', compact('userData'));
    ...
    public function admin_profile_update(Request $request)
    {
        ...
        if ($affectedRow == 1) {
            return redirect('manager/profile')->with('success', trans("Profile Updated Successfully!"));
        } else {
    ...
    public function admin_account()
    {
        ...
        return view('manager.account', compact('userData'));
    }
    ...
    public function update_admin_account(Request $request)
    {
        ...
        if ($affectedRow == 1) {
            return redirect('manager/account')->with('success', trans("Account Updated Successfully!"));
        } else {
    ...
    public function admin_update_password(Request $request)
    {
        ...
        if (Hash::check($old_password, $oldPasswordHash->password)) {
            ...
            if ($affectedRow == 1) {
                ...
                return redirect('/manager/account')->with('success', trans("Password changed successfully!"));
            }
        } else {

            return redirect('/manager/account')->with('error', trans("Sorry! Old Password doesn't match!"));
        }
    ...
    public function users()
    {
        ...
        return view('manager.users', compact('user','role_id'));
    }
    ...
    public function add_users(Request $request)
    {
        ...
        if ($phoneExixt >= 1) {
            ...
            return redirect('manager/users')->with('success', trans("User registered successfully!"));
        }
    }
    ...
    public function view_users($id)
    {
        ...
        return view('manager.view.view_user', compact('userData','image'))->with('message');
    ...
    public function upload_image(Request $request)
    {
        ...
        if ($affectedRow == 1) {
            return redirect('manager/users/view/'.$request->id)->with('success', trans("Profile Image Updated Successfully!"));
        } 
    ...
    public function update_users(Request $request)
    {
        ...
        if ($affectedRow == 1) {
            return redirect('manager/users/view/'.$id)->with('success', trans("Operator Profile Updated Successfully!"));
        } else {
            return back()->with('error', trans("Profile is Already Updated!"));
        }
    }
        ...
        if ($affectedRow == 1) {
            ...
            $affectedRowRole = DB::table('role_user')
                ...
                if ($affectedRowRole == 1) {
                    ...
                    return redirect('manager/users')->with('success', trans("Users Deleted successfully!"));
                }
