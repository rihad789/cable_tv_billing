...
class AreaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('owner.area',compact('areasData','vicinitiesData'));
    }
    ...
    public function add_area(Request $request)
    {
        ...
        if($check_area==1)
        {
            return redirect("owner/area_vicinity")->with('error', trans("Sorry!This area already exists in the database"));
        }
        else
        {
        ...
        return redirect("owner/area_vicinity")->with('error', trans("New Area added sucessfully!"));
    }
    ...
    public function delete_area($id)
    {
        ...
        if ($affectedRow == 1) {
            ...
            return redirect('owner/area_vicinity')->with('success', trans("Area Deleted successfully!"));
    ...
    public function add_vicinity(Request $request)
    {
        ...
        if($check_vicinity==1)
        {
            return redirect("owner/area_vicinity")->with('error', trans("Sorry! This vicinity already exist in the database"));
        }
        else
        {
        ...
        return redirect("owner/area_vicinity")->with('error', trans("New Vicinity added successfully!"));
    }
    ...
    public function delete_vicinity($id)
    {
        ...
        if ($affectedRow == 1) {
            return redirect('owner/area_vicinity')->with('success', trans("Vicinity Deleted successfully!"));
        }
