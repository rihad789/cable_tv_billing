...
class MemoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($check_memo_no==1)
        {
            return redirect("owner/memo")->with('error', trans("সরি!এই মেমো নং ডাটাবেজে জমা আছে!"));
        }
        else
        {
            $memo=Memo::create([
        ...
        return redirect("owner/memo")->with('error', trans("নতুন হিসাব যুক্ত সম্পুর্ন হয়েছে!"));
