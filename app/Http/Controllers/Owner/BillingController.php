...
class BillingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('owner.billing', compact('billingData', 'paid_bills', 'due_bill', 'subscribersData', 'total_bill', 'paid_today', 'due_this_month', 'total_this_month', 'paid_this_month'));
    }
    ...
    public function collect_collection($id)
    {
        ...
        return redirect('/owner/billing/bill_collection')->with('success', trans("Collection handedover Successfully"));
    ...
    public function billcollection()
    {
        ...
        return view('owner.bill_collection', compact('collectors','billingData', 'paid_bills', 'due_bill', 'subscribersData', 'total_bill', 'paid_today', 'due_this_month', 'total_this_month', 'paid_this_month'));
    }
