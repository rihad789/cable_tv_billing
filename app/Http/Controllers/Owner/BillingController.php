...
class BillingController extends Controller
{
    ...
    public function billcollection()
    {
        ...
        return view('owner.bill_collection', compact('billingData','paid_bills','due_bill','subscribersData','total_bill','paid_today','due_this_month','total_this_month','paid_this_month')); 
