        ...
        <div class="row">
            <div class="col-12 col-lg-4 d-flex">
                <div class="card border shadow-none w-100">
                    <div class="card-body">
                        <form class="row g-3" id="add_subscriber_form" action="{{ url('sallery/add') }}" method="post" accept-charset="utf-8">
                            @csrf
                            ...
                            <table id="dataTables" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-right">
                                            <a href="{{ url('sallery/settle/'.$val->id) }}" onclick="return confirm('You are about to pay {{ $val->sallery_amount }} Taka to {{ $val->first_name }} , {{ $val->last_name }}.Are you sure?')" class="ui circular basic icon button tiny">Pay Sallery</a>
                                        </td>
                                        @endif
