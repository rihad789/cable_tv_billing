        ...
        <div class="col-md-6">
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <form id="edit_system_user_form" action="{{ url('employee/my_account/update') }}" class="ui form add-user" method="post" accept-charset="utf-8">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-success">
                <div class="box-body">
                    ...
                    <form id="changePasswordForm" action="{{ url('employee/my_account/update_password') }}" class="ui form add-user" method="post" accept-charset="utf-8">
