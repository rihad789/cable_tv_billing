    ...
    <div class="wrapper">
        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="{{ url('billing/bill_collection') }}">
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ url('area') }}"><i class="bi bi-arrow-right-short"></i>Area</a>
                        </li>
                        <li> <a href="{{ url('vicinity') }}"><i class="bi bi-arrow-right-short"></i>Vicinity</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ url('memo/add') }}"><i class="bi bi-plus"></i>Add Memo</a>
                        </li>
                        <li> <a href="{{ url('memo') }}"><i class="bi bi-list-check"></i>Memo List</a>
                        </li>
                        <li> <a href="{{ url('memo/history') }}"><i class="bi bi-check2-circle"></i>Settled Memo</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="{{ url('account_diary/settlements') }}">
                ...
                <li>
                    <a href="{{ url('memo/add') }}">
                        ...
                        <div class="menu-title">Add Memo</div>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ url('memo') }}">
                        ...
                        <div class="menu-title">Memo List</div>
                    </a>
                </li>
