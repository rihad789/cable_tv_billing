            ...
            <div class="col-12 col-lg-6 d-flex">
                <div class="card border shadow-none w-100">
                    <div class="card-body">
                        ...
                        <form class="row g-3" id="add_subscriber_form" action="{{ url('my_profile/update_profile') }}" method="post" accept-charset="utf-8">
                            @csrf
            ...
            <div class="col-12 col-lg-6 d-flex">
                <div class="card border shadow-none w-100">
                    <div class="card-body">
                        ...
                        <form id="edit_system_user_form" action="{{ url('my_account/update') }}" class="row g-3" method="post" accept-charset="utf-8">
                        ...
                        <form id="edit_system_user_form" action="{{ url('my_account/update_password') }}" class="row g-3" method="post" accept-charset="utf-8">
