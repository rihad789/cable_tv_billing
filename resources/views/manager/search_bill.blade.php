            ...
            <div class="col-12 col-lg-8 d-flex">
                <div class="card border shadow-none w-100">
                    <div class="card-body">
                        ...
                        <form class="row g-3" id="add_subscriber_form" action="{{ url('manager/billing/collect_bills') }}" method="post" accept-charset="utf-8">
...
var url = '/manager/subscriber/search/' + client_id;
