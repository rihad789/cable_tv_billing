        ...
        <div class="row">
            <div class="col-12 col-lg-4 d-flex">
                <div class="card border shadow-none w-100">
                    <div class="card-body">
                        <form class="row g-3" id="add_subscriber_form" action="{{ url('manager/subscriber/add') }}" method="post" accept-charset="utf-8">
                            @csrf
                            <div class="col-md-6">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-right">
                                            ...
                                            <div class="d-flex align-items-center gap-3 fs-6">
                                                <a href="{{ url('/manager/subscriber/search/'.$val->client_id) }}" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Views"><i class="bi bi-eye-fill"></i></a>
                                            </div>
