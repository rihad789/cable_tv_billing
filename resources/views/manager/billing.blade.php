            ...
            <div class="col-12 col-lg-4 d-flex">
                <div class="card border shadow-none w-100">
                    <div class="card-body">
                        ...
                        <form class="row g-3" id="add_area_form" action="{{ url('manager/billing') }}" method="post" accept-charset="utf-8">
                            @csrf
                        ...
                        <div class="col-12" style="margin-top: 20px;">
                                <div class="d-grid">
                                    <button onclick="location.href='/manager/billing/generate'" class="btn btn-primary">Generate Bills</button>
                                </div>
                            </div>
