<div class="ui modal medium add">
    ...
    <div class="content">
        <form id="add_new_calculation" action="{{ url('admin/account/store') }}" class="ui form add-user" method="post" accept-charset="utf-8" style="overflow-y:scroll;height:400px;">
            @csrf
