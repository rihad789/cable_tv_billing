                                    ...
                                    <tr>
                                        ...
                                        <td class="align-right">
                                            ...
                                            <div class="d-flex align-items-center gap-3 fs-6">
                                                <a href="{{ url('subscriber/search/'.$val->client_id) }}" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Views"><i class="bi bi-eye-fill"></i></a>
                                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#area").change(function() {
            ...
            $.ajax({
                url: '/subscriber/getVicinity/' + area,
                type: 'get',
                dataType: 'json',
