                                                                                        ...
                                                                                        <table id="example" width="100%"  class="table table-striped table-bordered" data-order='[[ 0, "asc" ]]'>
                                                                                                ...
                                                                                                <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                                ...
                                                                                                                <td><a href="{{ url('/owner/billing/collect_collection/'.$val->id) }}" onclick="return confirm('You are about to receive {{ $val->amount}} Taka from  {{ $val->first_name}} , {{ $val->last_name}} . Collection day: {{ $val->day}} ')" class="ui circular basic icon button tiny" class="text-primary">Collect Bills</a></td>
                                                                                                                @else
                                                                                                                <td>Collected</td>
                                                                                                                @endif
                                                                                                        </tr>
