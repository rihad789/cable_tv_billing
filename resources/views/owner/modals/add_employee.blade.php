<div class="ui modal medium add">
    ...
    <div class="content">
        <form id="add_system_user_form" action="{{ url('owner/employee/add') }}"  class="ui form add-user" autocomplete="off" method="post" accept-charset="utf-8">
            @csrf
            ...
            <div class="field">
                ...
                <input id="email" type="email" name="email" class="block mt-1 w-full" autocomplete="off" autofocus="off">
            </div>
