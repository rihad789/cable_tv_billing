            ...
            <div class="box box-success">
                ...
                <div class="box-content">
                    ...
                    @if($connection_status==1 && $due_bill >=3 )
                        ...
                        <button onclick="location.href='/owner/subscriber/cut_lock_fund/@isset($subscriberData->client_id){{ $subscriberData->client_id }}@endisset'" class="btn btn-danger float-right"><i class="dollar sign icon"></i>Settle Due</button>
                        <button onclick="location.href='/owner/subscriber/billing/@isset($subscriberData->client_id){{ $subscriberData->client_id }}@endisset'"  class="btn btn-info float-right"><i class="eye icon"></i>Complete Bills </button>     
                    </p>
