        ...
        <div class="row">
            <div class="box box-success">
                <div class="box-body">
                    ...
                    <form id="edit_system_user_form" action="{{ url('owner/users/update') }}" class="ui form add-user" method="post" accept-charset="utf-8">
        ...
        <div class="col-md-10">
            <div class="box box-success">
                ...
                <img src="/images/img/{{ $image }}" alt="Profile picture" class="rounded mx-auto d-block" style="width: 300px;height: 300px;">
                    ...
                    <form id="edit_system_user_form" action="{{ url('owner/users/upload_image') }}" class="ui form add-user" method="post" accept-charset="utf-8" enctype="multipart/form-data">
