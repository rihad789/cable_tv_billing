            ...
            <div class="col-12 col-lg-6 d-flex">
                <div class="card border shadow-none w-100">
                    <div class="card-body">
                        ...
                        <form id="add_subscriber_form" action="{{ url('account_diary/settle_account') }}" class="ui form add-user" method="post" accept-charset="utf-8">
                            @csrf
                                ...
                                <table class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{ $bill_due }} Taka</td>
                                            <td>{{ $bill_paid }} Taka</td>
                                            <td> <a href="{{ url('billing') }}" class="ui circular basic icon button tiny">{{ __('View BIllings') }}</a> </td>
                                        </tr>
                                    </tbody>
                                ...
                                <table class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{ $grand_total }} Taka</td>
                                            <td> <a href="{{ url('memo') }}" class="ui circular basic icon button tiny">{{ __('View Memos') }}</a> </td>
